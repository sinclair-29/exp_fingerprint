...
def build_parser() -> argparse.ArgumentParser:
    ...
    construct.add_argument("--method", required=True, choices=["trap", "proflingo", "llmprint", "sraf"])
    ...
    verify.add_argument("--method", required=True, choices=["trap", "proflingo", "llmprint", "sraf"])
